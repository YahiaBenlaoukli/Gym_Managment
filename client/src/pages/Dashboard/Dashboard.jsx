...
function Dashboard() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-white to-accent dark:from-secondary dark:via-primary dark:to-[#2d2d00] transition-colors duration-300">
            <Navbar />
            <Hero />
                    ...
                    <div className="mb-8 flex items-center justify-between">
                        ...
                        {products && products.length > 3 && (
                            <div className="flex gap-3">
                                <button
                                    onClick={prevSlide}
                                    className="w-10 h-10 rounded-full bg-white dark:bg-input-bg border border-gray-200 dark:border-accent/20 flex items-center justify-center text-gray-800 dark:text-white hover:bg-accent hover:text-secondary transition-all duration-300 shadow-sm"
                                >
                                    <ChevronLeft size={20} />
                                </button>
                                <button
                            ...
                            >
                                {products.map((prod) => (
                                    <div key={prod.id} className="w-full md:w-1/2 lg:w-1/3 flex-shrink-0 px-3">
                                        <div className="bg-white dark:bg-[rgba(26,26,26,0.95)] border border-gray-200 dark:border-accent/20 rounded-2xl p-4 h-full group hover:border-accent hover:shadow-lg dark:hover:shadow-[0_0_20px_rgba(255,235,59,0.15)] transition-all duration-300">
                                            <div className="relative overflow-hidden rounded-xl mb-4 aspect-[4/3]">
                                                ...
                                                <img
                                                    src={"http://localhost:3000" + prod.image_path || "https://images.unsplash.com/photo-1517836357463-d25dfeac3438?auto=format&fit=crop&w=800"}
                                                    alt={prod.name}
